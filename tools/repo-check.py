...
for needle,msg in (
    ...
    ('systemd-logind.service','host safety check no longer verifies systemd-logind'),
    ('XDG_RUNTIME_DIR','host safety check no longer verifies XDG_RUNTIME_DIR'),
    ('/run/user/$(id -u)','host safety check no longer verifies the canonical pam_systemd runtime directory'),
